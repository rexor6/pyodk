...
class CreateUpdateHealthCheckImapCommand(object):
    ...
    def __init__(self, port=143, timeout=7000, error_tolerance=51, name='', address='', interval=60, paused=False, locations_failover_enabled=True, notification_type_ids=None, notification_event_type_ids=None, notification_time_id=1594, description=None, _configuration=None):  # noqa: E501
        """CreateUpdateHealthCheckImapCommand - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def port(self):
        """Gets the port of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Port  # noqa: E501

        :return: The port of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this CreateUpdateHealthCheckImapCommand.

        Port  # noqa: E501

        :param port: The port of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: int
        """
    ...
    @property
    def timeout(self):
        """Gets the timeout of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Time the server has to complete the request in [ms]  # noqa: E501

        :return: The timeout of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this CreateUpdateHealthCheckImapCommand.

        Time the server has to complete the request in [ms]  # noqa: E501

        :param timeout: The timeout of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: int
        """
    ...
    def error_tolerance(self):
        """Gets the error_tolerance of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        How many (%) locations have to report an error to consider it a breakdown  # noqa: E501

        :return: The error_tolerance of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: int
        """
    ...
    def error_tolerance(self, error_tolerance):
        """Sets the error_tolerance of this CreateUpdateHealthCheckImapCommand.

        How many (%) locations have to report an error to consider it a breakdown  # noqa: E501

        :param error_tolerance: The error_tolerance of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Health check name  # noqa: E501

        :return: The name of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateUpdateHealthCheckImapCommand.

        Health check name  # noqa: E501

        :param name: The name of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: str
        """
    ...
    @property
    def address(self):
        """Gets the address of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        URL or IP address of the monitored service  # noqa: E501

        :return: The address of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this CreateUpdateHealthCheckImapCommand.

        URL or IP address of the monitored service  # noqa: E501

        :param address: The address of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: str
        """
    ...
    @property
    def interval(self):
        """Gets the interval of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Time interval between health checks, in seconds  # noqa: E501

        :return: The interval of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: int
        """
    ...
    def interval(self, interval):
        """Sets the interval of this CreateUpdateHealthCheckImapCommand.

        Time interval between health checks, in seconds  # noqa: E501

        :param interval: The interval of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: int
        """
    ...
    @property
    def paused(self):
        """Gets the paused of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Is paused  # noqa: E501

        :return: The paused of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: bool
        """
        return self._paused
    ...
    def paused(self, paused):
        """Sets the paused of this CreateUpdateHealthCheckImapCommand.

        Is paused  # noqa: E501

        :param paused: The paused of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: bool
        """
    ...
    def locations_failover_enabled(self):
        """Gets the locations_failover_enabled of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Use random substitute locations in case of location breakdown  # noqa: E501

        :return: The locations_failover_enabled of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: bool
        """
    ...
    def locations_failover_enabled(self, locations_failover_enabled):
        """Sets the locations_failover_enabled of this CreateUpdateHealthCheckImapCommand.

        Use random substitute locations in case of location breakdown  # noqa: E501

        :param locations_failover_enabled: The locations_failover_enabled of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: bool
        """
    ...
    def notification_type_ids(self):
        """Gets the notification_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Notification types enabled for a health check  # noqa: E501

        :return: The notification_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def notification_type_ids(self, notification_type_ids):
        """Sets the notification_type_ids of this CreateUpdateHealthCheckImapCommand.

        Notification types enabled for a health check  # noqa: E501

        :param notification_type_ids: The notification_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: list[int]
        """
    ...
    def notification_event_type_ids(self):
        """Gets the notification_event_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Event types with enabled notification  # noqa: E501

        :return: The notification_event_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def notification_event_type_ids(self, notification_event_type_ids):
        """Sets the notification_event_type_ids of this CreateUpdateHealthCheckImapCommand.

        Event types with enabled notification  # noqa: E501

        :param notification_event_type_ids: The notification_event_type_ids of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: list[int]
        """
    ...
    def notification_time_id(self):
        """Gets the notification_time_id of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Time when notification is sent  # noqa: E501

        :return: The notification_time_id of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: int
        """
    ...
    def notification_time_id(self, notification_time_id):
        """Sets the notification_time_id of this CreateUpdateHealthCheckImapCommand.

        Time when notification is sent  # noqa: E501

        :param notification_time_id: The notification_time_id of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: int
        """
    ...
    def description(self):
        """Gets the description of this CreateUpdateHealthCheckImapCommand.  # noqa: E501

        Description  # noqa: E501

        :return: The description of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateUpdateHealthCheckImapCommand.

        Description  # noqa: E501

        :param description: The description of this CreateUpdateHealthCheckImapCommand.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateUpdateHealthCheckImapCommand, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateUpdateHealthCheckImapCommand):
            return False
